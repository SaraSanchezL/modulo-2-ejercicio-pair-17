...
books.adalab.es/materiales-del-curso-n/-MdR6Gp68BX20m1pi0z2/modulo-2-programando-la-web/javascript/2_1_intro_a_la_programacion</a></p>
<p class="item__seen">
<input type="checkbox" ${read1} name="item_imp_2" id="item_imp_2"></p>
<p class="item__desc">${description1}</p>
<ul class="item__tags">
<li class="item__tag">${tag1}</li><li class="item__tag">${tag2}</li></ul>
</article>
</li>`;
